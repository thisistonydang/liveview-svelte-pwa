...
#
#     PHX_SERVER=true bin/live_view_svelte_offline_demo start
#
...
if config_env() == :prod do
  ...
  config :live_view_svelte_offline_demo, LiveViewSvelteOfflineDemo.Repo,
    # ssl: true,
    url: database_url,
  ...
  config :live_view_svelte_offline_demo, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
